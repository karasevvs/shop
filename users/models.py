...
class ShopUserProfile(models.Model):
    ...
    tagline = models.CharField(max_length=150, blank=True, verbose_name='теги', null=True)
    about_me = models.TextField(blank=True, verbose_name='о себе', null=True)
    gender = models.CharField(choices=GENDER_CHOICES, blank=True, max_length=1, verbose_name='пол', null=True)
